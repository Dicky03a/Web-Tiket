            ...
            <form method="POST" action="{{ route('front.booking_store', $ticket->slug) }}" class="relative flex flex-col w-full px-4 gap-[18px] mt-5 pb-[30px] overflow-x-hidden">
                        ...
                        <div class="flex items-center gap-[14px]">
                              ...
                              <div class="flex flex-col gap-[6px]">
                                    ...
                                    <div class="flex items-center gap-1">
                                          ...
                                          <p class="font-semibold text-xs leading-[18px]">{{ $ticket->narahubung->name }}</p>
                                    </div>
                  ...
                  <div class="flex flex-col rounded-[30px] p-5 gap-[14px] bg-white">
                        <div class="flex flex-col gap-[6px]">
                              ...
                              <div class="flex items-center rounded-full px-5 gap-[10px] bg-[#F8F8F9] focus-within:ring-1 focus-within:ring-[#F97316] transition-all duration-300">
                        ...
                        <div class="flex flex-col gap-[6px]">
                              <label for="date" class="font-semibold text-sm leading-[21px]">Date</label>
                              <div class="flex items-center rounded-full px-5 gap-[10px] bg-[#F8F8F9] focus-within:ring-1 focus-within:ring-[#F97316] transition-all duration-300">
                                    <img src="{{ asset('assets/images/icons/mobile.svg') }}" class="w-6 h-6" alt="icon">
